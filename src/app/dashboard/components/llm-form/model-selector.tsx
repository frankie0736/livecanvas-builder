									...
									<div className="grid grid-cols-1 gap-1.5">
										{models.map((model) => (
											<button
												...
												key={`model-${model.id}`}
												className={cn(
													"grid w-full grid-cols-[minmax(0,1fr)_auto] items-center gap-2 rounded-md px-3 py-2.5 text-left text-sm transition-all duration-150",
											...
											>
												<span className="min-w-0 break-words font-medium text-zinc-800 dark:text-zinc-200">
													{model.name}
												</span>
