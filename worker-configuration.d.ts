/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a7ef6cde96609bdcec55b826749ba46)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: R2Bucket;
	DB: D1Database;
	CHAT_GENERATION: Workflow<Parameters<import("./src/server").ChatGenerationWorkflow['run']>[0]['payload']>;
}
